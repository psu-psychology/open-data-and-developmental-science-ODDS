...
subtitle: "Child Study Center (CSC)"
author: "Rick Gilmore"
date: "`r Sys.time()`"
css: ioslides.css
output: 
...
- Where are we now
- Where we want to go
- Feedback on strategic plan components
...
- Open Data & Developmental Science (ODDS) initiative
    ...
    - Policies and practices (e.g., Gilmore, Cole, et. al., in press)
    - [Databrary.org](https://databrary.org)
    - Local hosting of ABCD database (M. Hallquist)
...
- New faces at Old Main
    ...
    - National search for new CIO/VP IT
...
- What must we continue? What might be phased-out?
